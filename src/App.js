...
function PageContent({ pageId, user }) {
  ...
  switch (pageId) {
    ...
    case "tracking": return user.role === "retailer"
      ? <RetailerTrackingPage {...props} />
      : <LiveTrackingPage {...props} />; case "history": return <RetailerHistoryPage {...props} />;
...
function MainLayout({ user, onLogout }) {
  ...
  useEffect(() => {
    // Keep a background interval to trigger live-update feel in child pages
